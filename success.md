...
**Mean ratings per top genre**
<div style="width: 100%;display: flex; justify-content: center;">
  {% mean_ratings_by_top_genres.html %}
</div>
This bar chart presents the average movie ratings for different genres. We can see that 'Drama' and 'Family' genres have similar ratings, which are higher than the 'Action/Adventure', 'Fiction', and 'Horror' genres. 'Other' genres have the highest mean rating, suggesting that there may be specific genres within this category that resonate well with audiences. It is interesting to note the relatively lower mean rating for 'Horror', which could be due to various factors including audience preferences or critical reception.
...
<div style="width: 100%;display: flex; justify-content: center;">
  {% distribution_of_movie_box_office_revenue.html %}
</div>
...
<div style="width: 100%;display: flex; justify-content: center;">
  {% distribution_of_movie_profit.html %}
</div>
...
<div style="width: 100%;display: flex; justify-content: center;">
  {% movie_rating_vs_profit_scatter.html %}
</div>
...
<div style="width: 100%;display: flex; justify-content: center;">
  {% distribution_of_movie_average_ratings_per_continent.html %}
</div>
...
<div style="width: 100%;display: flex; justify-content: center;">
  {% Distribution_inflated_movies.html %}
</div>
...
<div style="width: 100%;display: flex; justify-content: center;">
  {% box_plot_of_movie_box_office_revenue_by_main_genre.html %}
</div>
